...
class VendorRequestView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Vendor Request Form"),
        centerTitle: true,
        elevation: 1,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildBanner("vendor_logo.png", "Become a Vendor!",
                "Upgrade your account to connect with buyers and grow your business."),
            const SizedBox(height: 20),
            _buildTextField(nameController, "Shop Name", "Enter your shop name"),
            const SizedBox(height: 15),
            _buildTextField(addressController, "Address", "Enter your shop address"),
            const SizedBox(height: 15),
            _buildTextField(aboutController, "About Shop", "Describe your shop", maxLines: 4),
            const SizedBox(height: 15),
            _buildTextField(vendorTypeController, "Vendor Type", "Retailer, Wholesaler, etc."),
