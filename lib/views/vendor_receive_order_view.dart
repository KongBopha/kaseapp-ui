...
class _VendorReceiveOrderCardStatefulState
    extends State<VendorReceiveOrderCardStateful> {
  final ReceiveOrderRespondController controller = Get.find();

  void _showFarmerProfile(BuildContext context, VendorReceivePreorderModel preOrder) async {
    showDialog(
      context: context,
          ...
          children: [
            ...
            if (user.vendor != null) ...[
              ...
              _buildSection(
                ...
                icon: Icons.business,
                children: [
                  _buildInfoTile(icon: Icons.store, label: 'Company Name', value: user.vendor?.companyName ?? 'N/A'),
